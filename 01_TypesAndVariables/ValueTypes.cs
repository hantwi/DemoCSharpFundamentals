...
namespace _01_TypesAndVariables
{
    ...
    public class ValueTypes
    {
        ...
        {
            float floatExample = 1.65498165481616818168486191f;
            double doubleExample = 1.65498165481616818168486191d;
            decimal decimalExample = 1.65498165481616818168486191m;
        ...
        public void Structs()
        {
            ...
            DateTime birthday = new DateTime(1988, 08, 29);
